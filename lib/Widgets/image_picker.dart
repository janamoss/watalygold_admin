...
class _UploadPageState extends State<UploadPage> {
              ...
              Padding(
                ...
                child: TextButton(
                  ...
                  style: TextButton.styleFrom(
                    ...
                    backgroundColor: const Color.fromRGBO(0, 35, 102, 1),
                  ),
                  child: uploading
                      ? SizedBox(
  ...
  uploadImageToStorage(PickedFile? pickedFile, String knowledgetId) async {
    ...
    Reference reference =
        FirebaseStorage.instance.ref().child('Knowledge/$knowledgetId/knowledImg_$kId');
